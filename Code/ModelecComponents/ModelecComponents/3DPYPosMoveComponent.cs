...
{
    public class _3DPYPosMoveComponent : GH_Component
    {
        SharedData dataset;
        bool testBtnClick;
        RhinoDoc myDoc;
        ...
        /// </summary>
        public _3DPYPosMoveComponent()
          : base("3DPrintedPartMovePosY", "PPMoveYP",
              "Move the 3D-printed part toward the positive direction of the Y axis",
              "Modelec", "3DP-Control")
        {
        ...
        {
            get { return new Guid("57efc420-0057-4d8b-9d41-f502368f5d41"); }
        }
    }
}