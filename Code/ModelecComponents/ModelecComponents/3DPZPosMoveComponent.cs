...
{
    public class _3DPZPosMoveComponent : GH_Component
    {
        SharedData dataset;
        bool testBtnClick;
        RhinoDoc myDoc;
        ...
        /// </summary>
        public _3DPZPosMoveComponent()
          : base("3DPrintedPartMovePosZ", "PPMoveZP",
              "Move the 3D-printed part toward the positive direction of the Z axis",
              "Modelec", "3DP-Control")
        {
        ...
        {
            get { return new Guid("57efc420-0057-4d8b-9d41-f502368e5d45"); }
        }
    }
}