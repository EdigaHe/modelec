...
{
    public class _3DPYNegMoveComponent : GH_Component
    {
        SharedData dataset;
        bool testBtnClick;
        RhinoDoc myDoc;
        ...
        /// </summary>
        public _3DPYNegMoveComponent()
          : base("3DPrintedPartMoveNegY", "PPMoveYN",
              "Move the 3D-printed part toward the negative direction of the Y axis",
              "Modelec", "3DP-Control")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (isOn && !dataset.currPart3DP.PartName.Equals("null"))
            {
                ...
                Transform m = Transform.Translation(new Vector3d(0, -1, 0));
        ...
        {
            get { return new Guid("57efc420-0057-4d8b-9d41-f502368f5d4e"); }
        }
    }
}