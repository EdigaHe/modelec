...
{
    public class NudgeRightComponent : GH_Component
    {
        bool testBtnClick;
        RhinoDoc myDoc;
        TargetBody currBody;
        ...
        /// <summary>
        /// Initializes a new instance of the NudgeRightComponent class.
        /// </summary>
        public NudgeRightComponent()
          : base("NudgeRightComponent", "NRight",
              "Right nudge the part",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (toExePrtNudge)
            {
                ...
                else
                {
                    ...
                    Point3d newPos = currPos + plane_pt.XAxis / plane_pt.XAxis.Length * step;
        ...
        {
            get { return new Guid("a15a6981-6c68-4bd5-a5ed-54b87d8f0d64"); }
        }
    }
}