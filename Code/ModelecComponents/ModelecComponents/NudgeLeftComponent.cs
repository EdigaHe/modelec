...
{
    public class NudgeLeftComponent : GH_Component
    {
        bool testBtnClick;
        RhinoDoc myDoc;
        TargetBody currBody;
        ...
        /// <summary>
        /// Initializes a new instance of the NudgeLeftComponent class.
        /// </summary>
        public NudgeLeftComponent()
          : base("NudgeLeftComponent", "NLeft",
              "Left nudge the part",
        ...
        {
            get { return new Guid("01277d08-437b-4c96-98f1-70c640e73ea9"); }
        }
    }
}