...
{
    public class NudgeTopComponent : GH_Component
    {
        bool testBtnClick;
        RhinoDoc myDoc;
        TargetBody currBody;
        ...
        /// <summary>
        /// Initializes a new instance of the NudgeTopComponent class.
        /// </summary>
        public NudgeTopComponent()
          : base("NudgeTopComponent", "NTop",
              "Up nudge the part",
        ...
        {
            get { return new Guid("7b7e7940-ac20-4bd1-9c81-2c255c8e7e8d"); }
        }
    }
}