...
{
    public class _3DPZNegMoveComponent : GH_Component
    {
        SharedData dataset;
        bool testBtnClick;
        RhinoDoc myDoc;
        ...
        /// </summary>
        public _3DPZNegMoveComponent()
          : base("3DPrintedPartMoveNegZ", "PPMoveZN",
              "Move the 3D-printed part toward the negative direction of the Z axis",
              "Modelec", "3DP-Control")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (isOn && !dataset.currPart3DP.PartName.Equals("null"))
            {
                ...
                Transform m = Transform.Translation(new Vector3d(0, 0, -1));
        ...
        {
            get { return new Guid("57efc420-0057-4d8b-9d41-f502368f5de5"); }
        }
    }
}